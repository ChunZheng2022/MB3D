...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default="cfgs/kitti_models/MB3D.yaml", help='specify the config for training')
...
def main():
    ...
    args.start_epoch = max(args.epochs - 60, 0)  # Only evaluate the last 10 epochs
